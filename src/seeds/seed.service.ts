  ...
  async seed() {
    ...
    await this.prisma.$executeRaw`
      ...
      VALUES
        ...
        (49995, 'EXPENSE', 'Electronics repair', '2025-03-21', 4, 1),
        (7890, 'INCOME', 'Stock gains', '2025-03-21', 13, 1),
        (1234, 'EXPENSE', 'Public transport', '2025-03-21', 8, 1),
        (25600, 'INCOME', 'Consulting fee', '2025-03-21', 11, 1),
        (4500, 'EXPENSE', 'Gym membership', '2025-03-21', 10, 1),
        (67823, 'INCOME', 'Rental income', '2025-03-21', 14, 1),
        (3215, 'EXPENSE', 'Pharmacy items', '2025-03-21', 1, 1),
        (14567, 'EXPENSE', 'Home supplies', '2025-03-21', 4, 1),
        (8999, 'INCOME', 'Online sale', '2025-03-21', 12, 1),
        (23045, 'EXPENSE', 'Car maintenance', '2025-03-21', 5, 1),
        (5678, 'INCOME', 'Cashback reward', '2025-03-21', 13, 1),
        (1599, 'EXPENSE', 'Mobile plan', '2025-03-21', 7, 1),
        (43210, 'EXPENSE', 'Furniture purchase', '2025-03-21', 3, 1),
        (76543, 'INCOME', 'Project milestone', '2025-03-21', 11, 1),
        (2995, 'EXPENSE', 'Movie tickets', '2025-03-21', 9, 1),
        (12345, 'INCOME', 'Tax refund', '2025-03-21', 14, 1),
        (8765, 'EXPENSE', 'Clothing purchase', '2025-03-21', 2, 1),
        (34567, 'EXPENSE', 'Home renovation', '2025-03-21', 6, 1),
        (4321, 'INCOME', 'Interest income', '2025-03-21', 12, 1),
        (6500, 'EXPENSE', 'Software license', '2025-03-21', 8, 1),
        (21050, 'INCOME', 'Side hustle', '2025-03-21', 13, 1),
        (1950, 'EXPENSE', 'Fast food', '2025-03-21', 10, 1),
        (450000, 'EXPENSE', 'Insurance payment', '2025-03-21', 4, 1),
        ...
        (45678, 'EXPENSE', 'Laptop repair', '2025-03-21', 2, 1),
        (765000, 'INCOME', 'Freelance project', '2025-03-21', 13, 1),
        (3415, 'EXPENSE', 'Laundry service', '2025-03-21', 10, 1),
        (12345, 'INCOME', 'Commission', '2025-03-21', 11, 1);
    `;
